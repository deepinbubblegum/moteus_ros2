...
static const _MoteusStateStamped_type_support_symbol_names_t _MoteusStateStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moteus_msgs, msg, MoteusStateStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, moteus_msgs, msg, MoteusStateStamped)),
  }
};
...
{
  return &::moteus_msgs::msg::rosidl_typesupport_cpp::MoteusStateStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, moteus_msgs, msg, MoteusStateStamped)() {
  return get_message_type_support_handle<moteus_msgs::msg::MoteusStateStamped>();
}
