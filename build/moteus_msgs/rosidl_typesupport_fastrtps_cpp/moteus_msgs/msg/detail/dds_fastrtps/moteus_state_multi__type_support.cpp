...
#include "moteus_msgs/msg/detail/moteus_state_multi__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const moteus_msgs::msg::MoteusStateMulti *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moteus_msgs::msg::MoteusStateMulti *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MoteusStateMulti__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moteus_msgs::msg::MoteusStateMulti *>(
...
static size_t _MoteusStateMulti__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MoteusStateMulti(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MoteusStateMulti__callbacks = {
  "moteus_msgs::msg",
  "MoteusStateMulti",
...
static rosidl_message_type_support_t _MoteusStateMulti__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MoteusStateMulti__callbacks,
...
{
  return &moteus_msgs::msg::typesupport_fastrtps_cpp::_MoteusStateMulti__handle;
}
